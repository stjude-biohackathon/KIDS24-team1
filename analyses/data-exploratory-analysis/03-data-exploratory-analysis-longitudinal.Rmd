...
cat("  \n<div style=\"font-size:80%\">  \n")
print(knitr::kable(tables1, align = "lcccc", caption = "Summary of cohort per brain cancer type, SJUID, disease stage, and assay"))
cat("  \n</div>  \n")
cat("  \n\\pagebreak  \n")
```
...
# Run function
fname <- paste0(figures_plots_dir, "/", "cancer-type-brain-patient-assay.pdf")
p <- create_stacked_barplot(plot_df = tables1, 
