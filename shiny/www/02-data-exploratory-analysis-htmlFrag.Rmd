...
attach(params)
if (dir.exists(file.path("FragCohortOut", user))) {
  unlink(file.path("FragCohortOut", user), recursive=TRUE)
  dir.create(file.path("FragCohortOut", user))
} else {
  dir.create(file.path("FragCohortOut", user))
}
analysis_dir <- file.path("FragCohortOut", user)
